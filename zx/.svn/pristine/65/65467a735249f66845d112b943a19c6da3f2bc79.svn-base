...
/**
 * WordPaster专用
 * Created by zhangshuai on 2016/4/14.
 */
public class Uploader {
    public PageContext m_pc;
    String m_folder;		//上传文件夹。D:\\webapps\\upload\\
    String m_curBasePath;	//当前文件路径。http://localhost:8080/
    String m_filePathRel;	//文件在服务器中的相对路径。http://localhost:8080/upload/2012/05/24/
     ...
     * 获取文件相对路径。
     * 返回值：
     * 		http://localhost:8080/upload/2012/05/24/11223344.png
     * */
