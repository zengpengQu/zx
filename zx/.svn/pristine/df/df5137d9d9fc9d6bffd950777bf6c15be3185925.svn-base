                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <form class="form-horizontal" id="privatePassportForm" role="form" autocomplete="off" method="post">
                                <input id="privatePassportId" name="id" type="hidden" value="${privatePassport.id}">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-group" style="margin-top: 20px;margin-bottom: 30px">
                                            <h1 align="center"
                                                ...
                                                <c:choose>
                                                    <c:when test="${privatePassport.id eq null}"> 护照信息新增</c:when>
                                                    <c:otherwise> 护照信息编辑</c:otherwise>
                                                </c:choose></h1>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-sm-8 ">
                                                <select class="form-control" id="form-field-peopleId"
                                                    ...
                                                    <c:forEach items="${dicUserList}" var="dicUser">
                                                        <option value="${dicUser.id}"  <c:if test="${privatePassport.dicUser.id eq dicUser.id}">selected</c:if> >${dicUser.empName}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 ">
                                                <input type="text" id="form-field-passportCode" name="passportCode"
                                                       class="form-control " value="${privatePassport.passportCode}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 ">
                                                <input type="text" id="form-field-signOrg" name="signOrg"
                                                       class="form-control " value="${privatePassport.signOrg}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-sm-8 ">
                                                <div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
                                                    <input class="form-control" name="signDate" id="form-field-signDate"
                                                           value="${privatePassport.jsonObject.signDate}" type="text"/>
                                            ...
                                            <div class="col-sm-8 ">
                                                <div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
                                                    <input class="form-control" name="validDate" id="form-field-validDate"
                                                           value="${privatePassport.jsonObject.validDate}" type="text"/>
                                                    <span class="input-group-addon">
                                                    <i class="fa fa-calendar bigger-110"></i>
                                                </span>
                                                </div>
                                    ...
                                    <div class="col-xs-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control limited" id="form-field-notes"
                                                      name="notes" maxlength="200" style="min-height: 100px;">${privatePassport.notes}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
