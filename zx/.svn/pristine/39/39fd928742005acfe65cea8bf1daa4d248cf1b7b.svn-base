...
<script type="text/javascript">
    ...
    $('.page-content-area').ace_ajax('loadScripts', scripts, function () {
        ...
        var loadUrl = '${basePath}/taiwan-card/load-user.do';
        var isCanTransactUrl = '${basePath}/taiwan-card/taiwan-card-is-can-transact.do';
        var transactUrl = '#page/taiwan-card/taiwan-card-transact';
