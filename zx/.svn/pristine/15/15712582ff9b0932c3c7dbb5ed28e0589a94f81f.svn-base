                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-group" style="margin-top: 20px;margin-bottom: 30px">
                                            <h1 align="center"
                                                style="font-weight:bolder;letter-spacing: 2pt;font-family:华文宋体">因公护照办理
                                            </h1>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 ">
                                                <input type="text" id="form-field-keepUnit" name="keepUnit"
                                                       class="form-control" value="${dicDepts.deptName}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
                                    ...
                                    <div class="row" align="center">
                                        <label class="col-sm-2 control-label text-right"
                                               style="font-weight: bold; color: deepskyblue;text-align: right;padding-right: 19px;">扫描件预览：</label>
                                        <div class="col-sm-8">
...
<script type="text/javascript">
    ...
    $('.page-content-area').ace_ajax('loadScripts', scripts, function () {
        ...
        $transactBtn.unbind('click').bind('click', function () {
            if ($businessPassportForm.validate().form()) {
                ...
                if (issueDate >= validDate) {
                    G.alert({message: '护照有效期应大于发照日期！'});
                } else {
                    var data = getBusinessPassportData();
                    $transactBtn.prop("disabled", true);
                    $backBtn.prop("disabled", true);
                    G.confirm({
                        message: '确认为该人员办理因公护照吗？',
        ...
        $businessPassportForm.tjValidate({
            //focusInvalid: true,
            rules: {
                passportNo: {required: true, maxlength: 16},
                issuePlace: {required: true, maxlength: 30},
                issueDate: {required: true},
                validDate: {required: true},
                keepUnit: {required: true, maxlength: 40},
                storeAddress: {required: true, maxlength: 40}
            },
            messages: {
        ...
        $backBtn.unbind('click').bind('click', function (e) {
            e.preventDefault();
            var listUrl = '#page/business-passport/business-passport-add';
