    ...
    <div class="tabbable">
            <ul class="tabbale-uls">
                <li class="active" style="    flex: unset;">
                    <a data-toggle="tab" href="#info">赴台通行证详情</a>
                </li>

                <li style="    flex: unset;">
                    <a data-toggle="tab" href="#record">赴台通行证流转记录</a>
                </li>
            </ul>
                            ...
                            <div class="profile-user-info profile-user-info-striped">
                                <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-value" style="text-align: center">
                                        <span class="editable">${taiWanCard.jsonObject.empName}</span>
                                    </div>
                                    <div class="profile-info-name" style="text-align: center">性别</div>
                                    <div class="profile-info-value" style="text-align: center">
                                        <span class="editable">${taiWanCard.jsonObject.sex}</span>
                                    </div>
                                    <div class="profile-info-name" style="text-align: center">出生日期</div>
                                    <div class="profile-info-value" style="text-align: center">
                                        <span class="editable">${taiWanCard.jsonObject.birthday}</span>
                                    </div>
                                    <%--<div class="profile-info-name" style="text-align: center">出生地点</div>
                                    <div class="profile-info-value" style="text-align: center">
                                        <span class="editable">${taiWanCard.jsonObject.birthplace}</span>
                                    </div>--%>
                                </div>
                                <div class="profile-info-row">
                                    <div class="profile-info-name" style="text-align: center">身份证号</div>
                                    <div class="profile-info-value" style="text-align: center">
                                        <span class="editable">${taiWanCard.jsonObject.idNumber}</span>
                                    </div>
                                    <div class="profile-info-name" style="text-align: center">工作部门</div>
                                    <div class="profile-info-value" style="text-align: center">
                                        <span class="editable">${taiWanCard.jsonObject.department}</span>
                                    </div>
                                    <div class="profile-info-name" style="text-align: center">证件号码</div>
                                    <div class="profile-info-value" style="text-align: center">
                                        <span class="editable">${taiWanCard.jsonObject.permitCode}</span>
                                    </div>
                                    <div class="profile-info-name" style="text-align: center">签发机关</div>
                                    <div class="profile-info-value" style="text-align: center">
                                        <span class="editable">${taiWanCard.jsonObject.signOrg}</span>
                                    </div>
                                </div>
                                <div class="profile-info-row">
                                    <div class="profile-info-name" style="text-align: center">签发日期</div>
                                    <div class="profile-info-value" style="text-align: center">
                                        <span class="editable">${taiWanCard.jsonObject.signDate}</span>
                                    </div>
                                    <div class="profile-info-name" style="text-align: center">有效期至</div>
                                    <div class="profile-info-value" style="text-align: center">
                                        <span class="editable">${taiWanCard.jsonObject.validDate}</span>
                                    </div>
                                    <div class="profile-info-name" style="text-align: center">保存状态</div>
                                    <div class="profile-info-value" style="text-align: center">
                                        <span class="editable">${taiWanCard.jsonObject.isBorrow}</span>
                                    </div>
                                    <div class="profile-info-name" style="text-align: center">创建时间</div>
                                    <div class="profile-info-value" style="text-align: center">
                                        <span class="editable">${taiWanCard.jsonObject.createTime}</span>
                                    </div>
                                </div>
                                <div class="profile-info-row">
                                    <div class="profile-info-name" style="text-align: center">更新时间</div>
                                    <div class="profile-info-value" style="text-align: center">
                                        <span class="editable">${taiWanCard.jsonObject.updateTime}</span>
                                    </div>
                                    <div class="profile-info-name" style="text-align: center">备注</div>
                                    <div class="profile-info-value" style="text-align: center">
                                        <span class="editable">${taiWanCard.jsonObject.notes}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                                                ...
                                                                <div class="widget-body">
                                                                    <div class="widget-main no-padding">
                                                                        ...
                                                                        <i class="ace-icon fa fa-share blue bigger-125"></i>
                                                                            ...
                                                                            备注:<a class="orange bolder">
                                                                                ${record.jsonObject.notes}</a></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
...
<script type="text/javascript">
    ...
    $('.page-content-area').ace_ajax('loadScripts', scripts, function () {
        ...
        $backBtn.click(function () {
            G.pjaxLoadPageContentDiv('#page/taiwan-card/taiwan-card-list');
        });
    });
</script>