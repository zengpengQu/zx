 ...
 */
@Entity
@Table(name="DM_CIM_CITY_SCENERY_INTRO",schema = "SCH_DUTY")
public class CitySceneryIntro extends IdEntity implements Jsonable, Serializable {

    private static final Logger LOG = LoggerFactory.getLogger(CitySceneryIntro.class);

    public CitySceneryIntro() {}
    ...
    @Getter
    @Setter
    private String citySceneryName;
    ...
    @Getter
    @Setter
    private String citySceneryIntro;
    ...
    public JSON getJsonObject() {
        ...
        jsonObject.put("citySceneryName", citySceneryName);
        jsonObject.put("citySceneryIntro", citySceneryIntro);
