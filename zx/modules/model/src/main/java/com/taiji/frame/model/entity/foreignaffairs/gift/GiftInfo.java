 ...
 */
@Entity
@Table(name = "FA_MOG_GIFTINFO", schema = "SCH_DUTY")
public class GiftInfo extends IdEntity implements Jsonable, Serializable {
...
//    public String giftState;
    ...
    public JSON getJsonObject() {
        ...
        jsonObject.put("giftTypeId", null == getDicGiftType() ?"":getDicGiftType().getId());
        ...
        jsonObject.put("giftFrameId", null == getGiftShelves() ? "" : getGiftShelves().getId());
