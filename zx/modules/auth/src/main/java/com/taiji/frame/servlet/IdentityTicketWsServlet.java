 ...
 * 验证票据
 */
public class IdentityTicketWsServlet extends HttpServlet {

	private String identityVerifyServiceEndpoint= ConstantV.identityVerifyServiceWsEndpoint_verifyTicket;
...
//    		System.out.println(vitr);    
        ...
        session.setAttribute("userinfo", errorinfo);
