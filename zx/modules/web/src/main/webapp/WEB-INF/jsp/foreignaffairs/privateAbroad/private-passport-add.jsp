...
<script type="text/javascript">
    ...
    $('.page-content-area').ace_ajax('loadScripts', scripts, function () {
        ...
        var loadUrl = '${basePath}/private-passport/load-user.do';
        var isCanTransactUrl = '${basePath}/private-passport/private-passport-is-can-transact.do';
        var transactUrl = '#page/private-passport/private-passport-transact';
