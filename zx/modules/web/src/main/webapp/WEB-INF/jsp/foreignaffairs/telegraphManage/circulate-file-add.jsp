                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <form class="form-horizontal" id="new-edit-form" role="form" method="post"
                                  autocomplete="off">
                                <input id="id-file-manage" name="fileId" type="hidden" value="${fileManage.id}">
                                <div class="row">
                                    <div class="col-xs-12">
...
<script type="text/javascript">
    ...
    $('.page-content-area').ace_ajax('loadScripts', scripts, function () {
        ...
        //其他全局变量
        var fd = new FormData();
        var fileId = $saveForm.find("#id-file-manage").val();
        var archiveFlag = $saveForm.find("#form-field-archiveFlag").val();

        //本地url
        var url = '${basePath}/circulate-record/load-circulate-file-save.do';
