                            ...
                            <form class="form-horizontal" role="form" id="saveForm">
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 ">
                                                <input type="text" id="form-field-deptName" name="deptName" readonly="readonly"
                                                       class="form-control" value="${model.orgDept.deptName}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right"
                                                   for="form-field-approver"> 审核人： </label>

                                            <div class="col-sm-9 ">
                                                <input type="text" id="form-field-approver" name="approver" readonly="readonly"
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 ">
                                                <input type="text" id="form-field-dicReason"
                                                       class="form-control" value="${dicReason.reason}" readonly="readonly"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
