...
<div class="row">
    <div class="col-xs-12">
        <form class="form-horizontal" role="form" id="saveForm" action="${basePath}/dept/dept-save.do"
              method="post">
                ...
                <div class="col-xs-9 col-sm-offset-1">
                    <div class="form-group">
                        <label class="col-sm-9 control-label no-padding-right">
                            您要添加的部门属于： <span class="required_">
                            ${dicDept.deptName}
                        </span>
                        </label>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-9 col-sm-offset-1">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 ">
                            <input type="text" id="form-field-deptDscr" name="deptDscr"
                                   class="form-control"/>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-sm-9 ">
                            <select class="form-control" id="form-field-category"
                                ...
                                <c:forEach items="${paramList}" var="paramLis">
                                    <option value="${paramLis.id}">${paramLis.name}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
