        ...
        <div class="profile-user-info profile-user-info-striped">
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable">${giftShelves.frameCode}</span>
                </div>
            </div>
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable">${giftShelves.jsonObject.frameState}</span>
                </div>
            </div>
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable">${giftShelves.frameName}</span>
                </div>
            </div>
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable">${giftShelves.frameFormat}</span>
                </div>
            </div>
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable">${giftShelves.jsonObject.purchaseTime}</span>
                </div>
            </div>
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable">${giftShelves.frameAgent}</span>
                </div>
            </div>
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable">${giftShelves.frameBearing}</span>
                </div>
            </div>
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable"> ${giftShelves.jsonObject.frameType}</span>
                </div>
            </div>
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable">${giftShelves.frameInstruction}</span>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="clearfix">
        <div class="col-xs-10 center" style="padding-left: 500px;">
