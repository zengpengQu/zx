...
<div class="row">
    <c:if test="${recordMap eq null}">
        <span style="text-align: center;display: block;">该文件无操作记录</span>
    </c:if>
                            ...
                            <div class="widget-box transparent">
                                <div class="widget-body">
                                    <div class="widget-main no-padding">
                                        ...
                                        <br />
                                        <span class="bigger-110">
                                        去向:<span style="color: #00af0e;font-weight: bold;font-size: 16px;font-family:仿宋, Arial, Helvetica, sans-serif;">${record.jsonObject.destination}</span>
                                        ，流转:<a class="orange bolder">${record.jsonObject.circulation}</a>
                                        </span>
                                        <br />
                                        <span class="bigger-110">
...
<script type="text/javascript">
    ...
    $('.page-content-area').ace_ajax('loadScripts', scripts, function () {
        var $backBtn = $("#backBtn");
        var localUrl = '#page/telegraph-manage/jump-to-telegraph-manage-list?flag=1';
        //返回操作
