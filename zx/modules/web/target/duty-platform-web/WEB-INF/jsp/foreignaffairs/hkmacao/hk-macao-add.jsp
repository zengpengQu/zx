...
<script type="text/javascript">
    ...
    $('.page-content-area').ace_ajax('loadScripts', scripts, function () {
        ...
        var loadUrl = '${basePath}/hk-macao/load-user.do';
        var isCanTransactUrl = '${basePath}/hk-macao/hk-macao-is-can-transact.do';
        var transactUrl = '#page/hk-macao/hk-macao-transact';
                ...
                if (className.indexOf('row-record-transact') !== -1) {
                    ...
                    $.post(isCanTransactUrl, {userId: userId}, function (map) {
                        if (map.result) {
                            ...
                            G.alert({message: '该人员已经办理过往来港澳证件!'});
                        }
                    });
                }
            }
