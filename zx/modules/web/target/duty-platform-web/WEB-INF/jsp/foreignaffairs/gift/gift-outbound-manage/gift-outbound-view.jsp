...
<div class="row">
    ...
    <div class="col-xs-10 col-sm-offset-1" style="padding-left: 0px;padding-right: 0px;">
        <div class="hidden">
        ...
        <div class="profile-user-info profile-user-info-striped">
            ...
            <div class="profile-info-row">
                <div class="profile-info-name"> 出库编码：</div>
            ...
            <div class="profile-info-row">
                <div class="profile-info-name"> 出库时间：</div>
    ...
    <div class="row">
        <div class="col-xs-10 col-sm-offset-1" style="margin-top: 15px;">
    ...
    $('.page-content-area').ace_ajax('loadScripts', scripts, function () {
        ...
        function initViewDialog($container) {
            $container.removeClass('hide').dialog({
                ...
                width: 800,
                modal: true,
                title: "<div class='widget-header header-bg'><h4 class='smaller'style='margin-top: 12px'><i class='ace-icon fa  fa-globe green'></i>查看礼品出库明细信息</h4></div>",
                title_html: true,
                close: function () {
