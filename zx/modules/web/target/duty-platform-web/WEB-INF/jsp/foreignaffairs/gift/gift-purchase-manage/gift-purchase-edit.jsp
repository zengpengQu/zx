        ...
        <div class="widget-box transparent">
            <div class="widget-body">
                <div class="widget-main">
                    <div class="row">
                        <div class="col-xs-12">
                            <form class="form-horizontal" id="giftPurchaseForm" role="form" method="post">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group" style="margin-top: 20px;margin-bottom: 30px">
                                            <h1 align="center"
                                                ...
                                                <c:choose>
                                                    <c:when test="${giftOutOrIn.id eq null}"> 礼品入库单信息新增</c:when>
                                                    <c:otherwise> 礼品入库单信息编辑</c:otherwise>
                                                </c:choose></h1>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 ">
                                                <input class="form-control" name="applicationPerson" id="form-field-applicationPerson"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 ">
                                                <div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
                                                    <input type="text" id="form-field-applicationTime" name="applicationTime"
                                                           class="form-control " value="${giftOutOrIn.jsonObject.applicationTime}"/>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label" for="form-field-transactor">经办人：<span
                                                    class="required">*</span></label>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label" for="form-field-purchaseTime" >入库时间：<span
                                                    class="required">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-xs-4">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label" for="form-field-isOutbound" >入库状态：<span
                                                    class="required">*</span></label>
                                            <div class="col-sm-8 ">
                                                <select class="form-control" id="form-field-isOutbound" name="isOutbound">
                                                    <option value="">---------请选择---------</option>
                                                    <c:forEach items="${dicParamList}" var="dicParam">
                                                        <option value="${dicParam.id}"  <c:if test="${giftOutOrIn.dicParam.id eq dicParam.id}">selected</c:if> >${dicParam.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label" for="form-field-outboundCode" >入库编码：<span
                                                    class="required">*</span></label>
...
<script type="text/javascript">
    ...
    $('.page-content-area').ace_ajax('loadScripts', scripts, function () {
        ...
        var saveUrl = '${basePath}/giftPurchase/load-purchase-save.do';
        ...
        function getAllgiftOutOrInData() {
            ...
            giftOutOrInData.outboundTime = $purchaseTime.val();
        ...
        $saveBtn.unbind('click').bind('click', function (e) {
            if ($giftPurchaseForm.validate().form()) {
                var data = getAllgiftOutOrInData();
                G.confirm({
                    message: '确认保存此条礼品入库信息吗？',
                    callback: function (result) {
                        if (result) {
                            ...
                            $.ajax({
                                ...
                                if (map.result === true) {
                                    ...
                                    // var editHash = '#page/giftPurchase/load-purchase-edit' + "?id=" + giftOutOrInId;
                                    // G.pjaxLoadPageContentDiv(editHash);
                                } else if (map.result === 'empty') {
                                    G.showGritterFail("请添加礼品入库信息!");
        ...
        $giftPurchaseForm.tjValidate({
            focusInvalid: true,
            rules: {
                activityName: {required: false, maxlength: 32},
                activityType: {required: false, maxlength: 32},
            ...
            messages: {
                ...
                purchaseTime: {required: "入库时间必须选择"},
                isOutbound: {required: "入库状态必须选择"},
                outboundCode: {required: "入库编码必须填写"},
            }
        });
        ...
        $addGiftOutOrinRecordsBtn.click(function (e) {
            ...
            if (giftOutOrInId === '') {
                ...
                G.showGritterFail('请先填写并保存入库单基本信息');
            } else {
        ...
        function initEditDialogGiftOutOrInRecordDialog($container) {
            ...
            $container.removeClass('hide').dialog({
                ...
                close: function () {
                    ...
                    var $giftStoreGridTable = $container.find("#grid-table-gift-store");
                    $giftStoreGridTable.jqGrid('GridUnload');
                },
